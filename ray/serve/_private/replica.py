...
from ray.serve._private.custom_autoscaling import INTERVAL_S
...
class RayServeReplica:
    ...
    def __init__(
        ...
        if deployment_config.autoscaling_config:
            interval_s = deployment_config.autoscaling_config.metrics_interval_s
        else:
            interval_s = INTERVAL_S
        logger.info("metrics push interval: %s s", interval_s)
