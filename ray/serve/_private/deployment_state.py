...
from ray.serve._private.custom_autoscaling import LOOK_BACK_PERIOD_S
...
class DeploymentStateManager:
    ...
    def get_current_autoscaling_metrics(self) -> Dict[str, List[float]]:
        metrics = {}
        for deployment_name, deployment_state in self._deployment_states.items():
            ...
            metrics[deployment_name] = current_num_ongoing_requests
        return metrics
