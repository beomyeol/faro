...
from pytorch_forecasting import NHiTS, TimeSeriesDataSet, EncoderNormalizer
from pytorch_forecasting.metrics import (
    NormalDistributionLoss, MQF2DistributionLoss, RMSE,
...
def main(args):
    ...
    net = NHiTS.from_dataset(
        ...
        log_interval=1000,
        log_val_interval=1000,
        hidden_size=args.layer_width,
        backcast_loss_ratio=0.0,
        n_blocks=[args.blocks for _ in range(args.stacks)],
